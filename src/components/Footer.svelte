...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <!--Email-->
        <p><b class="pr-2">Email</b> alloizeusjohndebelen1@gmail.com</p>
        ...
        <!--Linkedn-->
        <!--<p>
            <b class="pr-2">Linkedn</b>
            <a href="www.linkedin.com/in/alloizeus-john-de-belen-2a8a96275" target="_blank" class="text-violet-400"
                >AJ de Belen<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
